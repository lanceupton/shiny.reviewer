...
tracks). This will work fine, but you'll probably want to define your own
content and record reviews submitted by users. The below boilerplate code
leverages the provided methods to sync reviews to a Google Sheets file. It
assumes that you have called `DEV_auth_set()` to write an encrypted gs4 token to
...
**(TODO)** The left sidebar allows you to filter content based on the most recent review.
...
When a content button is clicked, a popup is displayed which allows you to
